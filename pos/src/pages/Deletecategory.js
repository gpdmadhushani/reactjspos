...
console.log(cate);
const response = await axios.delete(`http://localhost:8080/deletecategoriess/${cate}`);
...
<div className="text-center mb-5" >
    <h1 style={{marginTop:"5%"}}>Delete Category</h1>
...
<div className="form-group mb-3">
    <input type="text" className="form-control" onChange={handlename} value={name} required   placeholder=" "    style={{width:"90%"}}    />
...
<button type="submit"  onClick={deletedetails}     className="btn btn-primary" style={{marginLeft:"30%",width:"30%",height:"30%",marginTop:"5%"}}>Submit</button>
